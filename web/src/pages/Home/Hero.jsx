    ...
    <section className="relative min-h-screen bg-[#a8c74a] flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center px-6 sm:px-12 lg:px-16 py-24 lg:py-0 lg:w-[55%] order-2 lg:order-1">
        ...
        <motion.div
          ...
          className="inline-flex w-fit items-center gap-2 bg-[#241621]/8 border border-[#241621]/12 rounded-full px-4 py-2 mb-8"
        >
          <Sparkles size={13} className="text-[#4c1b1b]" />
          <span className="text-[#241621]/80 text-xs font-semibold font-display uppercase tracking-widest">
            Circular Fashion
          </span>
        </motion.div>
        ...
        <motion.h1
          ...
          className="font-display font-black leading-[1.0] tracking-tighter text-[#241621]"
          style={{ fontSize: 'clamp(2.6rem, 6vw, 5.5rem)' }}
        >
          Wear more.
          <br />
          <span style={{ color: '#4c1b1b' }}>Buy less.</span>
          <br />
          Fix what you
          <br />
          already own.
        ...
        <motion.p
          ...
          className="mt-6 text-[#241621]/70 font-display text-base sm:text-lg leading-relaxed max-w-lg"
        >
        ...
        >
          <Link
            to="/shop"
            className="inline-flex items-center gap-2.5 bg-[#241621] text-[#eef4d1] font-bold text-sm px-7 py-3.5 rounded-xl hover:bg-[#241621]/90 transition-all hover:shadow-xl font-display"
          >
            Shop Collection <ArrowRight size={16} />
          </Link>
          <Link
            to="/reimagine"
            className="inline-flex items-center gap-2.5 border-2 border-[#4c1b1b] text-[#4c1b1b] font-bold text-sm px-7 py-3.5 rounded-xl hover:bg-[#4c1b1b] hover:text-[#eef4d1] transition-all font-display"
          >
        ...
        >
          {HERO_STATS.map(s => (
            <div key={s.label}>
              <p className="text-2xl font-black text-[#241621] font-display">{s.value}</p>
              <p className="text-[#241621]/55 text-xs font-display mt-0.5 leading-tight">{s.label}</p>
            </div>
          ))}
        </motion.div>
      </div>
      ...
      <div className="lg:w-[45%] relative order-1 lg:order-2 min-h-[50vw] lg:min-h-0">
        ...
        <motion.div
          ...
          className="absolute bottom-10 left-4 sm:left-10 lg:-left-6 bg-[#241621] rounded-2xl px-5 py-4 shadow-2xl border border-[#eef4d1]/10"
        >
          <p className="text-[#e2a3c9] font-black text-xl font-display">7M tonnes</p>
