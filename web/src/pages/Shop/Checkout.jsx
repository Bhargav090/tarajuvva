  ...
  if (items.length === 0 && !done) {
    return (
      <div className="min-h-screen bg-[#eef4d1] flex flex-col items-center justify-center gap-5">
        ...
        <p className="text-[#341631] font-[Outfit] font-bold text-xl">Your cart is empty.</p>
    ...
    return (
      <div className="min-h-screen bg-[#eef4d1] flex items-center justify-center px-4">
        ...
        >
          ...
          <h2 className="text-3xl font-black text-[#341631] font-[Outfit] mb-3">Order Placed!</h2>
  ...
  return (
    <div className="min-h-screen bg-[#eef4d1] pt-20">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <h1 className="text-3xl font-black text-[#341631] font-[Outfit] mb-8">Checkout</h1>

        <div className="grid lg:grid-cols-[1fr_380px] gap-8">
          {/* Form */}
          <form onSubmit={onSubmit} className="bg-white rounded-3xl p-6 sm:p-8 border border-[#341631]/8 space-y-5">
            <h2 className="text-lg font-bold text-[#341631] font-[Outfit] mb-2">Shipping Details</h2>
            ...
            <div className="bg-[#eef4d1] rounded-xl p-4 border border-[#341631]/8">
              <p className="text-sm font-bold text-[#341631] font-[Outfit] mb-1">💳 Payment Method</p>
              <p className="text-xs text-[#341631]/55 font-[Poppins]">Cash on Delivery (COD) — Pay when your order arrives.</p>
            </div>
          ...
          <div className="bg-white rounded-3xl p-6 border border-[#341631]/8 h-fit">
            <h2 className="text-lg font-bold text-[#341631] font-[Outfit] mb-5">Order Summary</h2>
              ...
              {items.map(item => (
                <div key={item.id} className="flex gap-3 items-center">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-[#341631] font-[Outfit] truncate">{item.name}</p>
                    <p className="text-xs text-[#341631]/45 font-[Poppins]">Qty {item.qty}</p>
                  </div>
                  <span className="text-sm font-bold text-[#0b4722] font-[Outfit]">₹{(item.price * item.qty).toLocaleString('en-IN')}</span>
                </div>
              ))}
            </div>
            <div className="border-t border-[#341631]/8 pt-4 space-y-2">
              <div className="flex justify-between text-sm text-[#341631]/60 font-[Poppins]">
              ...
              <div className="flex justify-between text-lg font-black text-[#341631] font-[Outfit] pt-2 border-t border-[#341631]/8">
