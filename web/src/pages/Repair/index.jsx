      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            {/* Preview */}
            <div className="bg-white rounded-2xl p-6 border border-[#241621]/8">
              <h3 className="font-bold text-[#241621] font-display mb-4">{config.preview.title}</h3>
              <ul className="space-y-2">
                {config.preview.items.map(item => (
                  <li key={item} className="flex items-center gap-2.5 text-sm text-[#241621]/65 font-body">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#241621]/8">
            ...
            <p className="text-[#241621]/50 text-sm font-body mb-6">Be first to know when Repair goes live.</p>
