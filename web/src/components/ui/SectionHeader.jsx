...
export default function SectionHeader({
  ...
  return (
    <div className={`${center ? 'text-center' : ''} mb-12 sm:mb-16`}>
      ...
      <h2 className={`font-[Outfit] font-black leading-[1.05] tracking-tight text-[#341631] ${titleClass || 'text-4xl sm:text-5xl lg:text-6xl'}`}>
        {title}
        {titleLight && (
      ...
      {subtitle && (
        <p className="mt-5 text-base sm:text-lg text-[#341631]/60 font-[Poppins] leading-relaxed max-w-2xl mx-auto">
          {subtitle}
        </p>
      )}
