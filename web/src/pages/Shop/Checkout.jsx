  ...
  return (
    <div className="min-h-screen bg-white pt-2 sm:pt-4">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <h1 className="text-3xl font-black text-[#241621] font-display mb-8">Checkout</h1>

        <div className="grid lg:grid-cols-[1fr_380px] gap-8">
          {/* Form */}
          <form onSubmit={onSubmit} className="bg-white rounded-3xl p-6 sm:p-8 border border-[#241621]/8 space-y-5">
            <h2 className="text-lg font-bold text-[#241621] font-display mb-2">Shipping Details</h2>
          ...
          {/* Order summary */}
          <div className="bg-white rounded-3xl p-6 border border-[#241621]/8 h-fit">
            ...
            <div className="border-t border-[#241621]/8 pt-4 space-y-2">
              <div className="flex justify-between text-sm text-[#241621]/60 font-body">
                <span>Subtotal</span><span>₹{total.toLocaleString('en-IN')}</span>
              </div>
              <div className="flex justify-between text-sm text-[#241621]/60 font-body">
                <span>Shipping</span><span className="text-[#a8c74a] font-semibold">Free</span>
              </div>
              <div className="flex justify-between text-lg font-black text-[#241621] font-display pt-2 border-t border-[#241621]/8">
