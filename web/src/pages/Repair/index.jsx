        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-[#341631]/8">
              <h3 className="font-bold text-[#341631] font-[Outfit] mb-4">{config.preview.title}</h3>
              <ul className="space-y-2">
                {config.preview.items.map(item => (
                  <li key={item} className="flex items-center gap-2.5 text-sm text-[#341631]/65 font-[Poppins]">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#341631]/8">
            ...
            <p className="text-[#341631]/50 text-sm font-[Poppins] mb-6">Be first to know when Repair goes live.</p>
